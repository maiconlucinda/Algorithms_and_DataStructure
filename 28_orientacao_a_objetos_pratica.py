...
class Triangulo:
    # Método construtor, primeira que é executada dentro objeto instanciado.
    # O self é um parametro padrão que precisa ser adicionado, porém ele não causa efeito direto no resultado.
